/*
  # Time Off Tracking and App Blocking Feature

  1. New Tables
    - `offline_sessions` - Track user offline sessions with duration and completion status
  ...
  2. Enhanced User Stats
    - Add offline tracking metrics to existing user_stats table
  ...
  4. Triggers and Functions
    - Auto-update user stats when offline sessions complete
