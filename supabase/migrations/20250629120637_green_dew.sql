/*
  ...
  3. Security
    ...
    - Add policies for viewing public challenges

  4. Functions and Triggers
    - Function to update user stats after offline sessions
    - Trigger to automatically update stats
    - Function to setup default blocked apps
*/
...
-- Insert default offline challenges (use ON CONFLICT to avoid duplicates)
