...
interface InterventionSettingsScreenProps {
  navigation: any;
}
...
export const InterventionSettingsScreen: React.FC<InterventionSettingsScreenProps> = ({ 
  navigation 
}) => {
...
export default InterventionSettingsScreen;