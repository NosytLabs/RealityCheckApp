    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: '⏱️',
          type: 'navigation',
          route: '/settings/app-usage-limits',
          onPress: () => router.push('/settings/app-usage-limits'),
        },
        {
          id: 'downtime',
          ...
          icon: '🌙',
          type: 'navigation',
          route: '/settings/scheduled-downtime',
          onPress: () => router.push('/settings/scheduled-downtime'),
        },
        {
          id: 'interventions',
          ...
          icon: '🧘',
          type: 'navigation',
          route: '/settings/intervention-settings',
          onPress: () => router.push('/settings/intervention-settings'),
        },
      ],
    },
    {
